...
namespace Drupal\uc_expresspayepos\Plugin\Ubercart\PaymentMethod;
...
/**
 * Defines the expresspayepos payment method.
 *
 * @UbercartPaymentMethod(
 *   id = "expresspayepos",
 *   name =  "Экспресс платежи: EPOS",
 *   redirect = "\Drupal\uc_expresspayepos\Form\expresspayeposForm",
 * )
 */
class ExpresspayEpos extends PaymentMethodPluginBase implements OffsitePaymentMethodPluginInterface
{
	...
	{
		$build['label'] = [
			'#prefix'     => '<div class="uc-expresspayepos">',
			'#plain_text' => $label,
			'#suffix'     => '</div>',
		];
		$build['image'] = [
			'#theme'      => 'image',
			'#uri'        => drupal_get_path('module', 'uc_expresspayepos') . '/images/logo.png',
			'#alt'        => $this->t('expresspayepos'),
			'#attributes' => array('class' => array('uc-epos-logo'))
		];
	...
	public function buildConfigurationForm(array $form, FormStateInterface $form_state)
	{
		...
		$form['eposCode'] = array(
			...
			'#title'         => "Код в EPOS",
			'#description'   => 'Можно узнать в личном кабинете сервиса "Экспресс Платежи" в настройках услуги.',
			'#default_value' => $this->configuration['eposCode'],
			'#size'          => 16,
		);
		$form['token']  = array(
			'#type'          => 'textfield',
	...
	public function submitConfigurationForm(array &$form, FormStateInterface $form_state)
	{
		...
		$this->configuration['eposCode']       			= $form_state->getValue('eposCode');
	...
	{
		return "Оплата через систему EPOS";
	}
	...
	public function buildRedirectForm(array $form, FormStateInterface $form_state, OrderInterface $order = null)
	{
		...
		$request_params = array(
			...
			'Currency'          => 933,
			'ReturnType'        => 'redirect',
			'ReturnUrl'         => Url::fromRoute('uc_expresspayepos.complete', [], ['absolute' => true])->toString(),
			'FailUrl'           => Url::fromRoute('uc_expresspayepos.cancel', [], ['absolute' => true])->toString(),
			'Expiration'        => '',
			'Info'              => '',
